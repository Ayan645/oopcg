...
p1.setcolor(14);
dline I;
I.setline(x1+xmid,ymid-y1,x2+xmid,ymid-y2);
cout<<"Enter total number of line : ";
cin>>n;
for (i=0;i<n;i++)
{
cout<<"Enter co-ord of pt x1: ";
cin >>x1;
cout<<"Enter co-ord of pt y1: ";
cin >>y1;
cout<<"Enter co-ord of pt x2: ";
cin >>x2;
cout<<"Enter co-ord of pt y2: ";
cin >>y2;
I.setline(x1+xmid,ymid-y1,x2+xmid,ymid-y2);
I.drawl(15);
}
cout<<"\n Enter co-ord of centre of cirlce: ";
cout<<"\n Enter value of x : ";
cin>>x;
cout<<"\n Enter value of y : ";
cin>>y;
